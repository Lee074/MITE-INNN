...
public class EntitySpiderQueen extends EntityArachnid {
    ...
    , Items.voucherCore, Items.voucherFishing, Items.voucherPlanting, Items.voucherVillager, Items.voucherClubCore, Items.voucherZombieBoss, Items.voucherGhast, Items.voucherBedrock,
